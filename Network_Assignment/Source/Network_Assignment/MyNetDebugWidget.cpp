...
void UMyNetDebugWidget::UpdateNetworkSimulationSettings(const FMyBPNetworkSimulationSettings& InPackets)
{
	if (UWorld* World = GetWorld())
	{
		if (World->GetNetDriver() != nullptr)
		{
			...
			FMyBPNetworkSimulationSettingsText SimulationSettingText;
...
void UMyNetDebugWidget::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
